		  ...
		  'click .submit': function (e, value, row, index) {
				...
				if (id) {
					...
					// 按钮
						...
						GLOBAL.ajax("fee/pay/deduction/submit", {
							id : id
						}, function(e) {
							if (e.success) {
								layer.msg("提交成功！");
		    ...
		    'click .delete': function (e, value, row, index) {
				...
				if (id) {
					...
					// 按钮
						...
						GLOBAL.ajax("fee/pay/deduction/delete", {
							id : id
						}, function(e) {
							if (e.success) {
								layer.msg("删除成功！");
		    ...
		    'click .edit': function(e, value, row, index){
				...
				if (id) {
					options.param.id = id;
					GLOBAL.go("html/fee/payDeductionFee/payDeductionFeeEdit.html");
				}
		    },
		    'click .scan': function(e, value, row, index){
				...
				if (id) {
					...
					GLOBAL.go("html/fee/payDeductionFee/payDeductionFeeScan.html");
				}
		    },
...
$("#btnExcelExport").click(function() {
	var data = $("#searchForm").serializeObject();
	GLOBAL.ajax("fee/excel/payDeductionCount", data, function(e) {
		 if (e.success) {
            var url = "fee/excel/payDeductionFee.xls";
