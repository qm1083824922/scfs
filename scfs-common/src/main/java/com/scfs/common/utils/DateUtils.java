...
public class DateUtils {
	...
	public static String format(Date date) {
		SimpleDateFormat sdf = new SimpleDateFormat(DateFormatUtils.YYYY_MM_DD_HH_MM_SS);
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"当前季度的时间范围： " + DateFormatUtils.format(DateFormatUtils.YYYY_MM_DD_HH_MM_SS, currentQuarter.getStart())
						+ " - " + DateFormatUtils.format(DateFormatUtils.YYYY_MM_DD_HH_MM_SS, currentQuarter.getEnd()));
	}
}
