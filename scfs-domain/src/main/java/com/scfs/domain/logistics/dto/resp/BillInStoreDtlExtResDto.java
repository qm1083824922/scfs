 ...
 */
public class BillInStoreDtlExtResDto extends BillInStoreDtlResDto {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4230361812388309754L;
	...
	public String gettSupplierName() {
		return tSupplierName;
	}

	public void settSupplierName(String tSupplierName) {
		this.tSupplierName = tSupplierName;
	}
	...
	public String gettAppendNo() {
		return tAppendNo;
	}

	public void settAppendNo(String tAppendNo) {
		this.tAppendNo = tAppendNo;
	}
