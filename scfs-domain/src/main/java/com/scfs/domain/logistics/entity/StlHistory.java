...
public class StlHistory {
	...
	public BigDecimal getAvailableNum() {
		return (null == this.storeNum ? BigDecimal.ZERO : this.storeNum)
				.subtract(null == this.lockNum ? BigDecimal.ZERO : this.lockNum)
				.subtract(null == this.saleLockNum ? BigDecimal.ZERO : this.saleLockNum);
	}
	...
	public BigDecimal getAvailableAmount() {
		return (null == this.storeNum ? BigDecimal.ZERO : this.storeNum)
				.subtract(null == this.lockNum ? BigDecimal.ZERO : this.lockNum)
				.subtract(null == this.saleLockNum ? BigDecimal.ZERO : this.saleLockNum)
				.multiply(null == this.costPrice ? BigDecimal.ZERO : this.costPrice);
	}
	...
	public BigDecimal getLockAmount() {
		return (null == this.lockNum ? BigDecimal.ZERO : this.lockNum)
				.multiply(null == this.costPrice ? BigDecimal.ZERO : this.costPrice);
	}
