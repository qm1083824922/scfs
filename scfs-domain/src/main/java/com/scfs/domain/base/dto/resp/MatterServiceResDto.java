...
public class MatterServiceResDto extends BaseEntity {
	/** 事项id **/
	...
	private String depositPaidName;
	/** 待采金额 **/
	private String depositAmount;
	/** 服务费率类型 **/
	private Integer serviceRateType;
	private String serviceRateTypeName;
	/** 服务费率 **/
	private String serviceRate;
	/** 应收费用类型 **/
	private Integer recFeeType;
	private String recFeeTypeName;
	/** 应收费用备注 **/
	...
	private String serviceSettlementTimeName;
	/** 服务费结算时间备注 **/
	...
	private String costExpendTypeName;
	/** 预计年度业务毛利 **/
	...
	public String getDepositPaidName() {
		return depositPaidName;
	}

	public void setDepositPaidName(String depositPaidName) {
		this.depositPaidName = depositPaidName;
	}
	...
	public String getServiceRateTypeName() {
		return serviceRateTypeName;
	}

	public void setServiceRateTypeName(String serviceRateTypeName) {
		this.serviceRateTypeName = serviceRateTypeName;
	}
	...
	public String getRecFeeTypeName() {
		return recFeeTypeName;
	}

	public void setRecFeeTypeName(String recFeeTypeName) {
		this.recFeeTypeName = recFeeTypeName;
	}
	...
	public String getServiceSettlementTimeName() {
		return serviceSettlementTimeName;
	}

	public void setServiceSettlementTimeName(String serviceSettlementTimeName) {
		this.serviceSettlementTimeName = serviceSettlementTimeName;
	}
	...
	public String getLendWayName() {
		return lendWayName;
	}

	public void setLendWayName(String lendWayName) {
		this.lendWayName = lendWayName;
	}
	...
	public String getCostExpendTypeName() {
		return costExpendTypeName;
	}

	public void setCostExpendTypeName(String costExpendTypeName) {
		this.costExpendTypeName = costExpendTypeName;
	}
