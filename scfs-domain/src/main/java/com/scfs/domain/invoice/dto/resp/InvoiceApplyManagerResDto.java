...
public class InvoiceApplyManagerResDto {
	/** 自增ID */
	private Integer id;
	/** 申请编号 */
	...
	public static class Operate {
		...
		static {
			operMap.put(OperateConsts.DETAIL, BusUrlConsts.DETAILINVOICEITEM);
			operMap.put(OperateConsts.EDIT, BusUrlConsts.EDITINVOICEITEM);
			operMap.put(OperateConsts.SUBMIT, BusUrlConsts.SUBMITINVOICESERVICE);
			operMap.put(OperateConsts.DELETE, BusUrlConsts.DELETEINVOICESERVICE);
			operMap.put(OperateConsts.PRINT, BusUrlConsts.PRINT_INVOICE_APPLY);
